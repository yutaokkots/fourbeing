...
<img src="./Readme_files/fourbeing-logo.png" width="100%"/>
...
The app features openAI's GPT-3 Text-davinci-003 model as a collapsable React component to allow users to translate written text accurately between 15 languages. 

The App was built with a Django back-end supported by django-rest-framework to allow for RESTful communication from incoming requests. The models are PostgreSQL. 
...
- Being able to view other users' profiles, and saving favorite posts. 

- Introducing a recursive Reply model to allow for nested comments section.

- Messaging capability between users with either direct-messageing or websocket. 
